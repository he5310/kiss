...
const Home = AsyncCompHoc(() => import('./views/main/home').then(module => module.default));

const Explore = AsyncCompHoc(() => import('./views/main/explore').then(module => module.default));

const User = AsyncCompHoc(() => import('./views/user/route').then(module => module.default));

const InvalidRoute = AsyncCompHoc(() => import('./views/main/invalidRoute').then(module => module.default));

const Test = AsyncCompHoc(() => import('./views/main/test').then(module => module.default));
